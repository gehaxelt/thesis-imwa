 ...
 */
public class EditLongevityDifferSingle implements IDiffer<IDifference<Double>, IRevision> {
    ...
    private EditOnlyDiffer editOnlyDiffer = new EditOnlyDiffer();
    ...
    private double editOnly() {
        return this.editOnlyDiffer.calculateDiff(this.r_i.getParentRevision(), this.r_i).getDifference();
    }
