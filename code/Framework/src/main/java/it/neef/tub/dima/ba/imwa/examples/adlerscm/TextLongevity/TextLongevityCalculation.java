 ...
 */
public class TextLongevityCalculation extends ACalculation<IContributor, Double, IRevision, ArgumentsBundle> {
     ...
     */
    private DataSet<IRelevanceScore> textOnlyRelevanceScoreDataSet;
    ...
    public void preProcess() {
        ...
        this.iRevisionDataSet = this.iRevisionDataSet.map(new MapFunction<IRevision, IRevision>() {
            ...
            public IRevision map(IRevision iRevision) throws Exception {
                IDiffer differ = new TextLongevityDiffer();
                // We calculate the alpha_text(r)
    ...
    public void postProcess() {
        // Finally, we have to calculate alpha_text(r) * txt(r), so use the aggregator to multiply all elements
        ...
        this.contributorRelevanceScoreDataSet = AdlerContributionMeasuresUtils.revisionScoreDataSetToContributorScore(
                ag.mul(this.getBaseResult(), this.textOnlyRelevanceScoreDataSet)
        );
    }
}
